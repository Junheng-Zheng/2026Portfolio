...
const CARD_PROJECTS = [
  ...
  // ...HOME_PROJECTS.filter(
  //   (project) =>
  //     !project.href?.startsWith("/work/") && project.title !== "Restaurant POS",
  // ).map((project) => ({
  //   ...project,
  //   tags: project.title.includes("Pomodoro") ? ["UI Exercise", "3D"] : [],
  // })),
];
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[720px] flex-col gap-8 p-6 md:gap-10 md:p-8 lg:p-10">
        <div className="flex w-full flex-col gap-4 text-white/70">
          <div className="relative aspect-square  w-[48px]  rounded-full overflow-hidden">
            <Image
              src="/2027/jun.png"
              alt="Junheng Zheng"
              fill
          ...
          <div>
            ...
            >
              <span
                className="inline-block relative size-5 rounded-full shrink-0 bg-blue-500 align-middle"
                aria-hidden
              >
                {" "}
                <Image
              ...
              <span
                className="inline-block relative size-5 rounded-full -ml-2 shrink-0 bg-yellow-500 align-middle"
                aria-hidden
              >
                <Image
              ...
              <span
                className="inline-block relative size-5 rounded-full -ml-2 shrink-0 bg-green-500 align-middle"
                aria-hidden
              >
                <Image
            ...
            >
              <span
                className="inline-block relative size-5 rounded-full shrink-0 bg-green-500 align-middle"
                aria-hidden
              >
                <Image
                  src="/logos/miro.png"
              ...
              <span
                className="inline-block relative size-5  -ml-2  rounded-full shrink-0 bg-blue-500 align-middle"
                aria-hidden
              >
                <Image
                  src="/logos/figma.png"
          ...
          <p>
            ...
            <span
              className="inline-block size-5 rounded-full shrink-0 relative align-middle"
              aria-hidden
            >
              <Image
                src="/logos/tesl.png"

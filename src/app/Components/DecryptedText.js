...
export default function DecryptedText({
  ...
  useEffect(() => {
    ...
    // view / inViewHover: start encrypted, decrypt when visible
  ...
  }, [animateOn, text, encryptInstantly, triggerDecrypt, delay]);
  ...
  return (
    <motion.span
      ref={containerRef}
      className={`whitespace-pre-wrap ${parentClassName || "inline-block"}`}
      aria-label={text}
      {...animateProps}
      {...props}
    >

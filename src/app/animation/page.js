...
const FOOTER_LINK_CLASS =
  "inline-flex items-center gap-2 text-[16px] leading-normal text-[#919191] transition-colors hover:text-white/80 md:gap-3 md:text-[20px]";
...
function CursorPillMarquee({ comingSoon }) {
  ...
  const segment = (
    <span className="inline-flex shrink-0 items-center gap-1.5">
      <span>{label}</span>
      {!comingSoon && <ArrowUpRight size={20} strokeWidth={1.5} aria-hidden />}
    </span>
  );
  ...
  return (
    <span
      className={`inline-flex overflow-hidden rounded-full py-2 text-[20px] leading-normal shadow-lg ${pillClass}`}
    >
...
const AnimationPage = () => {
  ...
  return (
    <div className="min-h-dvh bg-[#161616] w-full flex flex-col max-md:overflow-x-hidden">
      <motion.div
      ...
      >
          ...
          <div className="px-24 max-md:px-5">
            <div className="overflow-hidden max-w-[442px]">
              <motion.p
                ...
                className="text-[16px] leading-normal text-white md:text-[20px]"
              >
          ...
          <div className="relative px-24 max-md:px-5">
            ...
            >
              ...
              <button
                ...
                className="inline-flex cursor-pointer items-center gap-2 text-[16px] leading-normal text-[#919191] transition-colors hover:text-white/80 md:gap-3 md:text-[20px]"
              >
        ...
        <div
          ref={workRef}
          className="overflow-hidden pt-14 pb-14 bg-[#161616] z-20 max-md:pt-8 max-md:pb-12"
        >
          <motion.section
        ...
        <div
          ref={aboutRef}
          className="flex w-full flex-col gap-8 px-24 pt-0  pb-16 text-[16px] leading-normal max-md:px-5 md:text-[20px] max-lg:gap-8 lg:flex-row lg:gap-0 lg:py-12 lg:pb-24"
        >
          <div className="w-full lg:w-1/5 lg:self-start lg:sticky lg:top-12">
            <h1 className="text-[40px] font-medium leading-[1] text-white sm:text-[48px] max-lg:leading-none lg:text-[64px] lg:leading-[64px]">
              About
            </h1>
          </div>
          <div className="flex w-full flex-col gap-8 border-white/10 max-lg:gap-8 lg:w-3/5 lg:gap-12 lg:border-r lg:border-l lg:px-10">
            <div>
          ...
          <div className="flex w-full flex-col gap-3 max-lg:pt-2 lg:w-1/5 lg:self-end lg:items-end lg:sticky lg:bottom-12">

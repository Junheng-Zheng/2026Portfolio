    ...
    <div className="max-w-[1800px] mx-auto font-light text-sm text-gray-800">
      ...
      <div className="w-full flex flex-col gap-4   lg:items-center  lg:px-24 lg:py-10 px-5 pb-12  py-12 justify-center">
        ...
        <div className="flex flex-wrap gap-2">
          <button className="cursor-pointer sm:w-fit w-full hover:scale-102 transition-all duration-300  active:scale-98   bg-orange-500  text-white px-5 py-3 rounded-full">
            Sign in with Google
          </button>
          <button className="cursor-pointer sm:w-fit w-full hover:scale-102 transition-all duration-300  active:scale-98  border border-gray-200 px-5 py-3 rounded-full">
            Learn More
          </button>
        </div>
      </div>
      <div className="lg:px-12 md:px-4">
        <div className="w-full lg:rounded-xl md:rounded-lg relative   flex flex-col gap-4  bg-orange-500 overflow-hidden z-1 white p-5 xl:px-48 lg:px-24 py-12">
          <div className="absolute top-0 left-0 w-full flex justify-between h-full">
